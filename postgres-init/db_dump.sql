...
SELECT pg_catalog.setval('public.test_id_seq', 10, true);
...
SELECT pg_catalog.setval('public.test_question_id_seq', 64, true);
...
SELECT pg_catalog.setval('public.user_test_id_seq', 7, true);
